...
_commander2.default.version(_package.version).usage('[options] <file> [otherFiles...]').option('-d, --output-dir [dir]', 'Output directory').option('-q, --quotes', 'Use double quotes instead of simple quotes for surround attributes').option('-p, --prefix <items>', 'Result file name prefix').option('-f, --files <items>', 'Input files').parse(process.argv);
...
if (Array.isArray(_commander2.default.files)) {
  files = _commander2.default.files;
} else if (typeof _commander2.default.files === 'string') {
  files = [_commander2.default.files];
} else {
