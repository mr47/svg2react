...
_commander2.default.version(_package.version).usage('[options] <file> [otherFiles...]').option('-d, --output-dir [dir]', 'Output directory').option('-q, --quotes', 'Use double quotes instead of simple quotes for surround attributes').parse(process.argv);
